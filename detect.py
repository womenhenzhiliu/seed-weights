...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        hl1 = 3.5 / 10  # 监测区域高度距离图片顶部比例
        wl1 = 2 / 10  # 监测区域高度距离图片左部比例
        hl2 = 3.5 / 10  # 监测区域高度距离图片顶部比例
        wl2 = 3 / 10  # 监测区域高度距离图片左部比例
        hl3 = 5 / 10  # 监测区域高度距离图片顶部比例
        wl3 = 3 / 10  # 监测区域高度距离图片左部比例
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/video/VID_20200918_204905.mp4', help='source')  # file/folder, 0 for webcam
